...
public class BodyPartsModel {
    ...
    public static List<BodyPartsModel> getBodyParts(){
        ...
        item.add(new BodyPartsModel(R.drawable.forehead_t,  R.drawable.forehead_t,R.raw.forehad));
        item.add(new BodyPartsModel(R.drawable.hand_t,  R.drawable.hand_t,R.raw.hand));
